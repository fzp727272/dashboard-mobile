...
gulp.task('vendor-js', function () {
    // console.log(1312)
    return gulp.src('app/src/vendor/**/*')
...
gulp.task('watch', function () {
    ...
    gulp.watch('app/src/vendor/**/*', ['vendor-js']);
    ...
    gulp.watch('app/dist/vendor/*').on('change', browserSync.reload);
});
...
gulp.task('dev', function (cb) {
    runSequence(['clean-files'], ['publish-fonts', 'publish-images', 'publish-audios', 'publish-css', 'publish-js','vendor-js'], 'inject', 'watch', cb);
});
